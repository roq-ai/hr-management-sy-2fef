...
import { getEmployeePersonalDataById } from 'apiSdk/employee-personal-data';
import { EmployeePersonalDataInterface } from 'interfaces/employee-personal-data';

function EmployeePersonalDataViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Employee Personal Data Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                <Box>
                  ...
                  >
                    Employee Personal Data Details
                  </Text>
                </Box>
                {hasAccess('employee_personal_data', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/employee-personal-data/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Employee Personal Data" text={data?.employee_personal_data} />

                <FormListItem label="Employee Photo" text={data?.employee_photo} />
