...
import { createEmployeePersonalData } from 'apiSdk/employee-personal-data';
...
function EmployeePersonalDataCreatePage() {
  ...
  const handleSubmit = async (values: EmployeePersonalDataInterface, { resetForm }: FormikHelpers<any>) => {
    setError(null);
    try {
      await createEmployeePersonalData(values);
      resetForm();
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Create Employee Personal Data',
              isCurrent: true,
            },
          ]}
        />
...
)(EmployeePersonalDataCreatePage);
