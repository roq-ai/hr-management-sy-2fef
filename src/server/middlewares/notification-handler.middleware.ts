...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'create.create': {
    roles: ['admin', 'owner', 'hr-manager', 'payroll-officer', 'employee', 'admin', 'power-user', 'reviewer', 'viewer'],
    key: 'new_guest_registration',
    tenantPath: [],
    userPath: [],
  },
  'update.update': {
    roles: ['admin', 'owner', 'payroll-officer', 'employee', 'admin', 'power-user', 'reviewer', 'viewer'],
